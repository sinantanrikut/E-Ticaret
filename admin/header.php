...
$_SESSION['user_id']=$usercek['user_id'];
...
<head>
	...
	<body class="app sidebar-mini sidebar-gone <?php if($usercek['tema']==1){ echo"dark-mode"; } ?>">
							...
							<div class="container-fluid">
								<div class="d-flex">
									...
									<div class="d-flex order-lg-2 ml-auto">
										<a href="index.html#" data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch">
											<svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
												<path d="M0 0h24v24H0V0z" fill="none"/><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
											</svg>
										</a>
...
<?php $url = substr($_SERVER['REQUEST_URI'], 7) ; ?>
<li class="icons-list-item"><a href="system/function.php?tema=<?php echo $usercek['tema']; ?>&url=<?php echo $url; ?>"><i class="fa fa-adjust" data-toggle="tooltip" title="" ></i></a></li>
								...
								<div class="dropdown header-message">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="header-dropdown-list message-menu" id="message-menu">
													<a class="dropdown-item border-bottom" href="index.html#">
												...
												<div class=" text-center p-2 border-top">
													<a href="index.html#" class="">See All Messages</a>
												</div>
											</div>
										</div>
										<div class="dropdown header-notify">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class=" text-center p-2 border-top">
													<a href="index.html#" class="">View All Notifications</a>
												</div>
											</div>
										</div>
...
" alt="img" class="avatar avatar-md brround">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="index.html#" class="dropdown-item text-center user pb-0 font-weight-bold"><?php echo $usercek['name']." ".$usercek['surname']; ?></a>
												...
												<a class="dropdown-item d-flex" href="index.html#">
